    ...
    <div class="container">
        ...
        <form id="addForm" action="${pageContext.request.contextPath}/admin/addStaff" method="post">    
            <div class="form-group">
                <label for="firstName">firstName :</label> <input class="form-control" name="staff.firstName" id="firstName" type="text" />
            </div>
            <div class="form-group">
                <label for="lastName">lastName :</label> <input class="form-control" name="staff.lastName" id="lastName" type="text" />
            </div>
            <div class="form-group">
                <label for="lastName">picture :</label> <input name="staff.picture" id="picture" type="file" />
            </div>
            <div class="form-group">
                <label for="email">email :</label> <input class="form-control" name="staff.email" id="email" type="text" />
            </div>
            <div class="form-group">
                <label for="password">password :</label> <input class="form-control" name="staff.password" id="password" type="password" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="username">username :</label> <input class="form-control" name="staff.username" id="username" type="text" />
            </div>
            <div class="form-group">
